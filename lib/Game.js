...
module.exports = class Game {
  ...
  nextWave() {
    ...
    //   //   meteor.dx =  meteor.dx * 5;
    //   //   meteor.dy = meteor.dy * 5;
    //   // });


    //   //this.meteors.dy = (this.meteors.dy * 10);
    //   nextLevel.play();
    //   setTimeout(chime.play(), 4000);
    // } 
    ...
    // wave 5
// do want a catch all case and the player goes until they fail or should the player win on 5?
    // if (this.meteorArray.length === 0 && 
    //   this.baseObjArray.length > 0 &&
    //   this.cannon.w > 0 &&
    //   this.waveCount > 3); 
    //   {
    //   this.populateMeteors(75);
    //   this.meteorsPickTarget();
    //   this.cannon.populateMissiles(10);
    //   this.waveCount += 1;
    //   nextLevel.play();
  ...
  cannonDestroyed() {
    this.explosionArray.forEach((explosion) => {
      if (this.cannon.y <= (explosion.y + explosion.radius) && 
