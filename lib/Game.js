...
module.exports = class Game {
	...
	gameLoop() {
		...
		for (let i = 0; i < this.meteorArray.length; i++) {
			...
			// 	if (this.meteorArray[i].y >= (this.explosionArray[j].y + this.explosionArray[j].radius) && this.meteorArray[i].y <= (this.explosionArray[j].y - this.explosionArray[j].radius) && this.meteorArray[i].x >= (this.explosionArray[j].x + this.explosionArray[j].radius) && this.meteorArray[i].x <= (this.explosionArray[j].x - this.explosionArray[j].radius)) {
